...
if os.path.isdir(_WEBAPP_DIST):
    ...
    # Serve preset thumbnails (generated by admin endpoint or pre-built)
    _PRESET_THUMBS_DIR = os.path.join(_WEBAPP_DIST, "preset-thumbs")
...
async def api_admin_generate_preset_thumbs(request: Request):
    ...
    thumbs_dir = os.path.join(_WEBAPP_DIST, "preset-thumbs")
